...
export default function HotelCard({ hotel, index }: { hotel: Hotel; index: number }) {
  ...
  return (
    <Link to={`/hotel/${hotel.slug}`}
      className="group block overflow-hidden rounded-2xl bg-shadow/5 p-1.5 ring-1 ring-black/5 transition-spring hover:-translate-y-2 hover:shadow-2xl">
      <div className="overflow-hidden rounded-[calc(1rem-6px)] bg-surface">
        ...
        <div className="p-4">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="inline-flex items-center gap-1 rounded-full bg-warm-gold-surface px-2.5 py-1 text-xs font-bold text-gold-dark">
          ...
          <div className="mt-5 flex items-end justify-between gap-3 border-t border-border/70 pt-4">
            ...
            <span
              ...
              className="inline-flex size-10 items-center justify-center rounded-full bg-primary text-white transition-spring-fast group-hover:bg-primary-hover group-hover:scale-105 active:scale-[0.95]"
            >
